...
\conferenceinfo{ICSE '16}{May 16-17 2016, Austin, TX, USA} 
\isbn{978-1-4503-4166-0/16/05}
\doi{http://dx.doi.org/10.1145/2897010.2897020}
...
%       \affaddr{Dep. of Computer Science}\\
       \affaddr{Sheffield, UK}
\alignauthor
 Andrea Arcuri \\
       \affaddr{Scienta, Norway}\\
       \affaddr{and University of Luxembourg}\\
%      \affaddr{P.O. Box 134, 1325 Lysaker, Norway}\\
...
\keywords{test case generation; search-based testing; testing classes;
