...
of exceeding Java's 64k limit on the size of methods. A trivial fix
...
% LA4J-3, LA4J-7: Phase INITIALIZATION lasted too long, Phase SEARCH lasted too long, 9 seconds more than allowed.
...
decreased. This is possibly due to crashes or out-of-memory
runtime errors.\TODO{confirm this conjecture}\TODO{look into details}
...
tests in one run (12 and 14, respectively).\TODO{look into details}

% Mocking
\TODO{Add some stats on mocking}
