...
increases for higher time budgets as expected, except for
$budget=300s$, where a decrease is observed, possibly due to crashes
or \emph{out-of-memory} errors\TODO{confirm this conjecture}. With
$budget=480s$, the average branch coverage achieved was \AvgCovG
(slightly higher than last year's $65.6\%$) and the average mutation
score was \AvgMutG (considerably higher than last year's $41.0\%$).
...
tools (\FlakyTthree by T3, \FlakyJtexpert by JTExpert, and
