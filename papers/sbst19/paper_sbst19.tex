...
\acmBooktitle{SBST'19: IEEE/ACM 12th International Workshop on Search-Based Software Testing, May 27, 2019, Montreal, Canada}
\acmPrice{15.00}
\acmDOI{}
\acmISBN{}
...
criteria~\cite{rojas2015combining}. Once the search is completed, \EVOSUITE applies various post-search optimisations aimed to improve the readability of
the generated tests. For example, tests are minimised and test assertions are selected using mutation analysis~\cite{10.1109/TSE.2011.93}. For more details on post-process optimisation we refer to~\cite{FrA11c,FrA13a}.
