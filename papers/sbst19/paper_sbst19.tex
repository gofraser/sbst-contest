...
\begin{table*}[t]
  \centering
  \caption{\label{table:results}Detailed results of \TT on the
    SBST benchmark classes.}
\vspace{-1em}
\resizebox{\textwidth}{!}{  
...
\TODO{why did we get 0\% coverage on most AUTHZFORCE benchmarks? and SPOON-169,
SPOON-25?}

\TODO{why did we get 0\% coverage on DUBBO-2 and WEBMAGIC-4? classpath was
incorrect.}

\TODO{what did we get 0\% coverage on SPOON-253, SPOON-20, SPOON-16, SPOON-155
for larger search budgets?}

\TODO{why did not we get data for FASTJSON-1, FASTJSON-3, FESCAR-41, FESCAR-42,
SPOON-105 for a search budget of 10 seconds?}
