...
public class CRSMatrix_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.la4j.Matrix", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("org.la4j.matrix.functor.MatrixPredicate", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixProcedure", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixOperation", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
