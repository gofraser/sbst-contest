...
public class BasicTypeConverter_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Collection", false, BasicTypeConverter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.List", false, BasicTypeConverter_ESTest_scaffolding.class.getClassLoader()));
  }
