...
public class CompressedVector_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorOperation", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorVectorOperation", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
