...
public class CompressedVector_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Collection", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.List", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Map", false, CompressedVector_ESTest_scaffolding.class.getClassLoader()));
