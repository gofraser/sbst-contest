...
public class BmpImageParser_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.RenderingHints$Key", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.image.BufferedImage", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.InputStream", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.OutputStream", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("java.util.function.Function", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.imaging.FormatCompliance", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.imaging.ImageFormat", false, BmpImageParser_ESTest_scaffolding.class.getClassLoader()));
