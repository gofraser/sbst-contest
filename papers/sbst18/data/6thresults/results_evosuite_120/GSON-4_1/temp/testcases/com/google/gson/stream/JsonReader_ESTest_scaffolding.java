...
public class JsonReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.PipedOutputStream", false, JsonReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Reader", false, JsonReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.charset.CharsetDecoder", false, JsonReader_ESTest_scaffolding.class.getClassLoader()));
