...
public class Matrix_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.CharSequence", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.Vector", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    ...
    mock(Class.forName("org.la4j.operation.MatrixMatrixOperation", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixOperation", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.DenseVector", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.VectorFactory", false, Matrix_ESTest_scaffolding.class.getClassLoader()));
