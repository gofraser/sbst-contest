...
public class MnPrint_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.freehep.math.minuit.MnPrint"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MnPrint_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.PrintWriter", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Iterator", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.List", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.freehep.math.minuit.ContoursError", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.freehep.math.minuit.MinosError", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.freehep.math.minuit.MnGlobalCorrelationCoeff", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.freehep.math.minuit.Point", false, MnPrint_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MnPrint_ESTest_scaffolding.class.getClassLoader()); 
