...
public class ReflectiveTypeAdapterFactory_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.FieldNamingStrategy", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.internal.ConstructorConstructor", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.internal.Excluder", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.internal.ObjectConstructor", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.internal.bind.ReflectiveTypeAdapterFactory$Adapter", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.stream.JsonWriter", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.Reader", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Map", false, ReflectiveTypeAdapterFactory_ESTest_scaffolding.class.getClassLoader()));
  }
