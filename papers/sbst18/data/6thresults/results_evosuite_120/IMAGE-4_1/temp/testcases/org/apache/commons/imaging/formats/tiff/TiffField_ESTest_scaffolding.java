...
public class TiffField_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.PrintWriter", false, TiffField_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.imaging.formats.tiff.fieldtypes.FieldType", false, TiffField_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.imaging.formats.tiff.taginfos.TagInfo", false, TiffField_ESTest_scaffolding.class.getClassLoader()));
  }
