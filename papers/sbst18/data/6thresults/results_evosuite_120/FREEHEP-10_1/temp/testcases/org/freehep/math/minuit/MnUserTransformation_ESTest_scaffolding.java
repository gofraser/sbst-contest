...
public class MnUserTransformation_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.freehep.math.minuit.MnUserTransformation"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MnUserTransformation_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Iterator", false, MnUserTransformation_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.List", false, MnUserTransformation_ESTest_scaffolding.class.getClassLoader()));
  }
