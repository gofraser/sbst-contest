...
public class GsonBuilder_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("com.google.gson.FieldNamingStrategy", false, GsonBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.TypeAdapterFactory", false, GsonBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.internal.Excluder", false, GsonBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.List", false, GsonBuilder_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Map", false, GsonBuilder_ESTest_scaffolding.class.getClassLoader()));
  }
