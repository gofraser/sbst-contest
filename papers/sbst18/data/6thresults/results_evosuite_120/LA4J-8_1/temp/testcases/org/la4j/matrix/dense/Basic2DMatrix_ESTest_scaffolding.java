...
public class Basic2DMatrix_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.matrix.dense.Basic2DMatrix"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Basic2DMatrix_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.MatrixFactory", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixAccumulator", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixFunction", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixProcedure", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixMatrixOperation", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixOperation", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorAccumulator", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Basic2DMatrix_ESTest_scaffolding.class.getClassLoader()); 
