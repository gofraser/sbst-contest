...
% EvoSuite vs Manual 
\newcommand{\AvgCovEvosuite}{{50.8\%}\xspace} 
\newcommand{\AvgMutEvosuite}{{36.9\%}\xspace} 
\newcommand{\AvgCovManual}{{53.8\%}\xspace} 
\newcommand{\AvgMutManual}{{54.3\%}\xspace} 
\newcommand{\EvoManCovA}{{0.45}\xspace} 
\newcommand{\EvoManCovPV}{{{0.367}}\xspace} 
\newcommand{\EvoManMutA}{{0.31}\xspace} 
